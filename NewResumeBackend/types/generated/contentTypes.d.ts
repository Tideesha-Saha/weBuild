...
export interface ApiUserResume2UserResume2 extends Struct.CollectionTypeSchema {
  collectionName: 'user_resume_2s';
  info: {
    displayName: 'user-resume-2';
    pluralName: 'user-resume-2s';
    singularName: 'user-resume-2';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-resume-2.user-resume-2'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-resume-2.user-resume-2': ApiUserResume2UserResume2;
